...
CREATE SEQUENCE artist_id_seq AS INT INCREMENT BY 1 START WITH 1 OWNED BY public.artist.id;
CREATE SEQUENCE vinyl_id_seq AS INT INCREMENT BY 1 START WITH 1 OWNED BY public.vinyl.id;
CREATE SEQUENCE author_id_seq AS INT INCREMENT BY 1 START WITH 1 OWNED BY public.author.id;
CREATE SEQUENCE book_id_seq AS INT INCREMENT BY 1 START WITH 1 OWNED BY public.book.id;
CREATE SEQUENCE category_id_seq AS INT INCREMENT BY 1 START WITH 1 OWNED BY public.category.id;
